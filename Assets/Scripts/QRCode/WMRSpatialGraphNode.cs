    ...
    internal class SpatialGraphNode
    {
        ...
        public bool TryLocate(FrameTime frameTime, out Pose pose)
        {
            pose = Pose.identity;
                ...
                Debug.Log("QRTracking: Before OriginSpatialCoordinateSystem");

#if WINDOWS_UWP
                System.IntPtr rootCoordnateSystemPtr = UnityEngine.XR.WindowsMR.WindowsMREnvironment.OriginSpatialCoordinateSystem;

                Debug.Log("QRTracking: After OriginSpatialCoordinateSystem"); 
                ...
                Debug.Log("QRTracking: After GetObjectForIUnknown");
